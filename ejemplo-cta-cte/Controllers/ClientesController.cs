...
namespace ejemplo_cta_cte.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ClientesController(CtaCteDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Nombre,Apellido,Dni,FechaDeNacimiento")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
